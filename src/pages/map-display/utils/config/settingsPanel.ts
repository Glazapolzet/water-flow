...
const W_PARAMETERS_SETTINGS_TAB_CONFIG = {
  ...
  Kt: {
    title: 'Коэффициент Кт, характеризующий относительную податливость почв разных типов и подтипов',
    options: KtOptions,
  },
  Km: {
    title: 'Коэффициент Км, характеризующий влияние механического состава почв на их относительную податливость эрозии',
    options: KmOptions,
  },
  Ke: {
    title: 'Коэфрициент Кэ, характеризующий влияние степени смытости почвы на их относительную податливость эрозии',
    options: KeOptions,
  },
  h: {
